...
def __listDevices(listDevices_updateID=''):
    ...
    # listDevices_updateID = response.info().getheader('updateID') npython3
    listDevices_updateID = response.info()['updateID']
...
def __getZones(getZones_updateID=''):
    ...
    #getZones_updateID = response.info().getheader('updateID') npython3
    getZones_updateID = response.info()['updateID']
